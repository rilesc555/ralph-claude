...
use theme::{
    get_spinner_frame, BG_PRIMARY, BG_SECONDARY, BG_TERTIARY, BORDER_SUBTLE, CYAN_PRIMARY,
    GREEN_ACTIVE, GREEN_SUCCESS, AMBER_WARNING, RED_ERROR, TEXT_MUTED, TEXT_PRIMARY,
    TEXT_SECONDARY,
};
use ui::{
...
use watcher::{build_ralph_prompt, setup_prd_watcher};
